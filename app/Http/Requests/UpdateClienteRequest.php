...
class UpdateClienteRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'correo' => 'required|email|max:255|unique:clientes,correo,' . $this->cliente->id,
            'telefono' => 'required|regex:/^[0-9]+$/|min:10|max:10|unique:clientes,telefono,' . $this->cliente->id,
        ];
    }
